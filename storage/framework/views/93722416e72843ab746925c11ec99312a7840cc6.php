...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid" style="padding-top:0px">
        <div class="row">
            ...
            <?php if(Auth::user()->role_code == "TRUE" || Auth::user()->role_code == "KBI" || Auth::user()->role_code == "ARISA"): ?>

            <?php elseif(Auth::user()->role_code == "MIS" || Auth::user()->role_code == "E - Billing"): ?>
           ...
           <div class="col-sm-4">
            ...
            <?php elseif(Auth::user()->role_code == "E - Purchasing"): ?>
            ...
            <?php elseif(Auth::user()->role_code == "E - Accounting"): ?>
...
<script>
    ...
    var user = "<?php echo e(Auth::user()->role_code); ?>";
    ...
    function drawChart() {
        $.get('<?php echo e(url("fetch/monitoring/invoice")); ?>', function(result, status, xhr) {
            if(xhr.status == 200){
                if(result.status){
                    var bulan = []
                    , jumlah = []
    ...
    function drawChartPch() {
        $.get('<?php echo e(url("fetch/monitoring_pch/invoice")); ?>', function(result, status, xhr) {
            if(xhr.status == 200){
                if(result.status){
                    var supplier = []
                    , jumlah = []
    ...
    function drawChartAcc() {
        $.get('<?php echo e(url("fetch/monitoring_acc/invoice")); ?>', function(result, status, xhr) {
            if(xhr.status == 200){
                if(result.status){
                    var supplier = []
                    , jumlah = []
