...
<head>
  ...
  <!-- <link rel="stylesheet" href="<?php echo e(url("css/bootstrap4.min.css")); ?>"> -->
  ...
  <!-- <link rel="stylesheet" href="<?php echo e(url("css/dashboard/style.min.css")); ?>"> -->
...
<body>
  <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="mini-sidebar"
    ...
    <?php echo $__env->make('admin.layouts.leftbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<!--   <script src="<?php echo e(url("bower_components/select2/dist/js/select2.full.min.js")); ?>"></script>
  ...
  <script src="<?php echo e(url('js/custom.js')); ?>"></script>
    ...
    <!--flot chart-->
    <script src="<?php echo e(url('assets/plugins/flot/jquery.flot.js')); ?>"></script>
    <script src="<?php echo e(url('assets/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js')); ?>"></script>
