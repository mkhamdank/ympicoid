...
<section class="content-header">
   <ol class="breadcrumb" style="margin-left:10px;margin-bottom: 0px !important;">
    <li><a href="<?php echo e(url("create/role")); ?>" class="btn btn-primary btn-md" style="color:white">Create <?php echo e($page); ?></a></li>
  </ol>
</section>
<?php $__env->stopSection(); ?>
        ...
        <div class="box-body">
          <table id="example1" class="table user-table no-wrap">
            ...
            <tbody>
              ...
              <tr>
                <td style="width: 15%"><?php echo e($role->role_code); ?></td>
                <td><?php echo e($role->role_name); ?></td>
                <td>
                  <center>
                    <a href="<?php echo e(url('edit/role', $role['id'])); ?>" class="btn btn-warning btn-xs">Edit</a>
                    <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal" onclick="deleteConfirmation('<?php echo e(url("destroy/role")); ?>', '<?php echo e($role['role_name']); ?>', '<?php echo e($role['id']); ?>');">
                      Delete
                    </a>
                  </center>
                </td>
