        ...
        <div class="row">
            ...
            <div class="col-lg-12" style="margin-top:20px;">
                <div class="center-heading">
                    ...
                    <h4 class="section-title" style="background-color: white;font-size: 12px;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;margin-bottom: 10px"><?php echo e($empsync[0]->employee_id); ?> - <?php echo e($empsync[0]->name); ?></h4>
                ...
                <div class="contact-form" style="background-color: white;padding: 15px;border-radius: 10px">
                    ...
                    <div class="row" id="vaksin_register">
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding-left: 20px;">
                            ...
                            <div class="validate-input" style="position: relative; width: 100% !important">
                                <input type="text" name="ktp" id="ktp" class="form-control" style="width: 100% !important;margin-bottom: 0px" placeholder="No. KTP" value="<?php echo e($empsync[0]->card_id); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding-left: 20px;">
                            ...
                            <div class="validate-input" style="position: relative; width: 100% !important">
                                <input type="text" name="birth_place" id="birth_place" class="form-control" style="width: 100% !important;margin-bottom: 0px" placeholder="Tempat Lahir" value="<?php echo e($empsync[0]->birth_place); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding-left: 20px;">
                            ...
                            <div class="validate-input" style="position: relative; width: 100% !important">
                                <input type="text" name="birth_date" id="birth_date" class="form-control" style="width: 100% !important;margin-bottom: 0px" placeholder="Tanggal Lahir" value="<?php echo e($empsync[0]->birth_date); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding-left: 20px;">
                            ...
                            <div class="validate-input" style="position: relative; width: 100% !important">
                                <input type="text" name="address" id="address" class="form-control" style="width: 100% !important;margin-bottom: 0px" placeholder="Alamat Sesuai KTP" value="<?php echo e($empsync[0]->address); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding-left: 20px;">
                            ...
                            <div class="validate-input" style="position: relative; width: 100% !important">
                                <input type="text" name="phone" id="phone" class="form-control" style="width: 100% !important;margin-bottom: 0px" placeholder="No. HP" value="<?php echo e($empsync[0]->phone); ?>">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function cekVaksin() {
        $('#loading').show();
        var data = {
            employee_id:'<?php echo e($empsync[0]->employee_id); ?>'
        }

        $.get('<?php echo e(url("vaksin/check")); ?>', data, function(result, status, xhr){
    ...
    function save() {
        ...
        $.get('<?php echo e(url("vaksin/input")); ?>', data, function(result, status, xhr){
            if(result.status == true){    
                $("#loading").hide();
    ...
    function saveRegister() {
        ...
        $.get('<?php echo e(url("vaksin/registration/input")); ?>', data, function(result, status, xhr){
            if(result.status == true){    
                $("#loading").hide();
