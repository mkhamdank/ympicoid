 ...
 <div class="limiter">
    <div class="container-login100" style="background-color:#eee">
      <div class="wrap-login100 p-t-35 p-b-20" style="padding:20px">
           <!-- p-b-70 -->
          <form id="FormDaftar" name="FormDaftar" method="post"  enctype="multipart/form-data" action="<?php echo e(url('reset/password/confirm')); ?>" >
          ...
          <div class="container-login100-form-btn" style="margin-top: 20px">
            <a class="login100-form-btn" style="text-decoration: none;background-color: red" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              Cancel
            </a>
          </div>
