                                ...
                                <div class="col-xs-12 col-md-12 col-lg-12" style="padding:0">
                                    ...
                                    <table id="tableQuestion" class="table table-bordered" style="overflow-x: scroll;border-collapse: collapse !important;width: 100%">
                                        ...
                                        <tbody id="" style="background-color: #fff;">
                                            ...
                                            <tr class="tab_<?php echo e($no+1); ?>" id="tab_<?php echo e($no+1); ?>">
                                                <td>
                                                    <label class="label-input1002" style="color: purple;margin-top: 0px;text-align: center;font-size: 18px"><span id="pertanyaan_survey<?= $no ?>"><?php echo e($qs->pertanyaan); ?></span></label>

                                                    <div class="validate-input" style="position: relative; width: 100%;">
                                                        <label class="radio_box" style="margin-top: 5px;font-size: 18px;">Ya
                                                            <input type="radio" id="jawabansurvey<?php echo e($no); ?>" name="jawabansurvey<?php echo e($no); ?>" value="Ya">
                                                        ...
                                                        <label class="radio_box" style="margin-top: 5px;font-size: 18px;">Kadang
                                                            <input type="radio" id="jawabansurvey<?php echo e($no); ?>" name="jawabansurvey<?php echo e($no); ?>" value="Kadang">
                                                            <span class="checkmark_box"></span>
                                                        </label>
                                                        <br>
                                                        ...
                                                        <label class="radio_box" style="margin-top: 5px;font-size: 18px;">Tidak
                                                            <input type="radio" id="jawabansurvey<?php echo e($no); ?>" name="jawabansurvey<?php echo e($no); ?>" value="Tidak">
                                                            <span class="checkmark_box"></span>
                                                        </label>
                                                    </div>
                                                    <br>
                                                    <div class="validate-input" style="position: relative; width: 100%">
                                                        <?php 
                                                        if ($no+1 != 1) { ?>
                                                        <button id="back_<?php echo e($no+1); ?>" class="btn btn-danger" type="button" onclick="backSurvey(this.id)" style="display: inline-block;background-color: red !important">
                                                            <span>
                                                                Back
                                                    ...
                                                    <button id="next_<?php echo e($no+1); ?>" class="btn btn-success" type="button" onclick="nextSurvey(this.id)" style="display: inline-block;float: right">
                                                        <span>
                                                            Next
                                            ...
                                            <div class="validate-input" style="width: 100%;">
                                                <span style="font-weight: bold;margin-top: 40px;">Page <?php echo e($no+1); ?> of <?php echo e($jml_pertanyaan_survey); ?></span>
                                            </div>

                                            <?php } else { ?>

                                            <div class="validate-input" style="width: 100%;">
                                                <span style="font-weight: bold;margin-top: 20px;float: right;">Page <?php echo e($no+1); ?> of <?php echo e($jml_pertanyaan_survey); ?></span>
                                            </div>
...
<script type="text/javascript">
    ...
    function cek_survey() {
        ...
        $.get('<?php echo e(url("check/data")); ?>', data, function(result, status, xhr){
            if (result.status) {
    ...
    function submitSurvey() {
        ...
        for(var i = 0;i < jumlah_pertanyaan_survey; i++){
            ...
            $.post('<?php echo e(url("survey_covid/input")); ?>', data, function(result, status, xhr){
