                                  ...
                                  <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                      <fieldset>
                                        ...
                                        <input type="text" class="form-control"  placeholder="NIK Karyawan" readonly="" value="<?php echo e($empsync[0]->employee_id); ?> - <?php echo e($empsync[0]->name); ?>">
                                      </fieldset>
                                    </div>
                                    <!-- <div class="col-lg-4 col-md-12 col-sm-12">
                                      <fieldset>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Lengkap" readonly="" value="<?php echo e($empsync[0]->name); ?>">
                                      </fieldset>
                                    </div> -->
                                     <div class="col-lg-6 col-md-12 col-sm-12">
                                      <fieldset>
                                        <input type="text" class="form-control" id="department" name="department" placeholder="Department" readonly="" value="<?php echo e($empsync[0]->department); ?>">
                                      </fieldset>
                                    </div>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.get('<?php echo e(url("post/emergency")); ?>', data, function(result, status, xhr){
