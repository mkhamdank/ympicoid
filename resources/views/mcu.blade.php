        ...
        <div class="row">
            ...
            <div class="col-lg-12" style="margin-top:20px;">
                <div class="center-heading">
                    <h2 class="section-title" style="background-color:#955ddf;color:white;margin-bottom: 0px;border-top-left-radius: 10px;border-top-right-radius: 10px;font-size: 15px">Bukti Penerimaan Hasil <br>Medical Check Up</h2>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.get('{{ url("post/mcu") }}', data, function(result, status, xhr){
